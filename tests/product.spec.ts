...
test('can create product', async ({ page }) => {
    ...
    console.log(randomAbstract);
    console.log(randomDOI);
    ...
    await page.getByPlaceholder('Email, phone, or Skype').fill(username || 'USER_ID');
    await page.getByRole('button', { name: 'Next' }).click();
    await page.getByPlaceholder('Password').click();
    await page.getByPlaceholder('Password').fill(password || 'USER_PASSWORD');
